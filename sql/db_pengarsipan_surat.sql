...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 15, 2021 at 06:14 AM
...
(1, 2021, 4, 'kejahatan', '1', 20, 22, 1631675244);
...
(1, '127.0.0.1', 'jaya', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'dd@aada', '', NULL, NULL, 'CiSl.fVzn.JJxaKtf.X4pu', 1268889823, 1631661821, 1, 'Ade Widianto', '', '', NULL, NULL),
...
(13, '090909923dsfsd', '2021-07-12', 'Khitanana', 'Dilmil Ambon', 'Camat', 4, NULL, 1, 'sdadfasf', 1626068680),
(14, '01293jkdjfds', '2021-09-15', 'sdfds', 'dsfd', 'sdfsdf', 1, NULL, 1, 'sdfdsfsdf', 1631666640),
(15, NULL, NULL, NULL, NULL, NULL, NULL, 'Rahasia', 1, NULL, 1631673464),
(16, NULL, NULL, NULL, NULL, NULL, NULL, '', 1, NULL, 1631673947),
(17, NULL, NULL, NULL, NULL, NULL, NULL, 'Segera', 1, NULL, 1631674746),
(18, NULL, NULL, NULL, NULL, NULL, NULL, 'Segera', 1, NULL, 1631674884);
...
(36, 'asd', '2021-07-27', 'asd', 4, 'asdas', NULL, 'asda', 1, NULL, NULL, 1625895913, 'Surat-23018.docx'),
(37, 'No.2323k', '2021-07-19', 'Aduan', 4, 'Otmil', NULL, 'selalu jaya', 1, NULL, NULL, 1626060984, 'Surat-28196.docx');
...
--
ALTER TABLE `nominatif`
  MODIFY `id_nominatif` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `surat_keluar`
  MODIFY `id_surat_keluar` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `surat_masuk`
--
ALTER TABLE `surat_masuk`
  MODIFY `id_surat_masuk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
