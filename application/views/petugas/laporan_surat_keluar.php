                    ...
                    <div class="panel panel-primary">
                        ...
                        <div id="collapseOne" class="collapse">
                            <div class="panel-body">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" onclick="laporan2('bulan_ini')">Bulan ini</button>
                                    <button type="button" class="btn btn-default" onclick="laporan2('minggu_ini')">Minggu ini</button>
                                    <button type="button" class="btn btn-default" onclick="laporan2('hari_ini')">Hari ini</button>
                                    <button type="button" class="btn btn-default" onclick="laporan2('bulan_kemarin')">Bulan Kemarin</button>
                                    <button type="button" class="btn btn-default" onclick="laporan2('kemarin')">Kemarin</button>
                                </div>

                                <hr>
                                <p>Berdasarkan rentang tanggal</p>
                                <form class="form-inline" action="<?php echo site_url('laporan/print_pdf/3') ?>" target="_blank" method="post">
...
<script>
    ...
    $(document).ready(function() {
        ...
        table = $('#laporanSuratKeluar').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('petugas/surat_keluar/tabel_surat_keluar'); ?>",
                "type": "POST"
            },
